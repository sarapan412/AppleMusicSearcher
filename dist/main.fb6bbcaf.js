...
var searchForm = document.querySelector("#search-form"); //submit searchform

searchForm.addEventListener("submit", fetchMusic); //fetch music data from apple music API

function fetchMusic(e) {
  e.preventDefault();
  var searchText = document.querySelector("#search-text").value; // if(isEmpty(searchText)) {
  //     showAlert("Please search something.", 'warning');
  //     return;
  // }

  var fetchUrl = "http://itunes.apple.com/search?term=".concat(searchText);
  (0, _fetchJsonp.default)(fetchUrl).then(function (res) {
    return res.json();
  }).then(function (data) {
...
function showMusic(musics) {
  ...
  for (var i = 0; i < musics.length; i++) {
    ...
    div.innerHTML = "\n            <img class = \"card-img-top\" src=".concat(music.artworkUrl100, " alt=\"Album Image\">\n            <div class=\"card-body\">\n                <h5 class=\"card-title\">").concat(music.trackName, "</h5>\n                <p class=\"card-text\">").concat(music.artistName, "</p>\n            </div>\n\n            <ul>\n\n                <li class = \"list-group list-group-flush\">").concat(music.collectionName, "</li>\n                <li class = \"list-group-item\">").concat(music.primaryGenreName, " \xB7 ").concat(music.releaseDate.split('-', 1), "</li>\n\n                <li class = \"list-group-item\">\n                    Sample: <br>\n                    <audio src=").concat(music.previewUrl, " controls = 'controls'></audio>\n                </li>\n            </ul>\n\n            <div class=\"card-body\">\n                <a href = ").concat(music.trackViewUrl, " class = \"card-link\">Shown in Apple Music</a>\n\n            </div>\n");
    results.appendChild(div);
  }
}
},{"fetch-jsonp":"node_modules/fetch-jsonp/build/fetch-jsonp.js","./validation":"js/validation.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
